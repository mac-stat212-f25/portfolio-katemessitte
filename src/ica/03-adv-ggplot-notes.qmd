...
- Relate the intro paragraph: "Scientists declared that 2015 was Earth’s hottest year on record..." to the *design* of the visualization.  In particular, based on the intro paragraph,
  ...
  NYT wants readers to explore their own cities wether patterns and see how 2015 compares to historical patterns.
  
  - How did this goal inform what information is displayed in the visualization?
  It means that there is a part that shows average and then one that shows the daily average from 2015 overlayed on one another. it also provides the options to switch through cities.

**Aesthetic Mapping** 

- What specific variables (from the data codebook) underlie the visualization?
Most likely the date in year
