...
```{r} 
data(diamonds)
# fit models of price vs carat seperatly for each value of cut
...
for (i in seq_along(lin_mod_res_for)) {
  this_formula <- df_arg_combos$mod_formula[[i]]
  this_remove_outliers <- df_arg_combos$remove_outliers[i]
